...
// ICONS
const vbIconFilterTag =
  'https://res.cloudinary.com/ferjen/image/upload/v1670427552/veggieBox/img/icons/vb-filter-tag-icon_bk9mtd.svg'
const vbIconUserTag =
  'https://res.cloudinary.com/ferjen/image/upload/v1670119538/veggieBox/img/icons/vb-user-tag-icon_ysjx1v.svg'
const vbIconSearchTag =
  'https://res.cloudinary.com/ferjen/image/upload/v1670212537/veggieBox/img/icons/vb-search-tag-icon_kuyjmf.svg'
            ...
            <Form className='category-bar--search'>
              <Button className='btn me-4 shadow-none bg-transparent border-0'>
                <img
                  ...
                  src='https://res.cloudinary.com/ferjen/image/upload/v1670212537/veggieBox/img/icons/vb-search-tag-icon_kuyjmf.svg'
                  alt='Search Icon'
                />
              </Button>
              <Form.Control
                type='search'
                placeholder='Search'
                className='ms-5 category-bar--control'
                aria-label='Search'
              />
            </Form>
          </div>
        ...
        <Col className='p-0 d-flex align-items-center justify-content-end'>
          <Dropdown align='start'>
            <Dropdown.Toggle className='btn m-0 shadow-0 bg-transparent border-0 pe-5'>
              <img
                className='category-bar--icon__filter position-absolute top-0 start-50 translate-middle'
                src='https://res.cloudinary.com/ferjen/image/upload/v1670427552/veggieBox/img/icons/vb-filter-tag-icon_bk9mtd.svg'
                alt='Icono para filtrar'
              />
            </Dropdown.Toggle>
            <Dropdown.Menu className='navbar--dropdown mt-4'>
              <Dropdown.Header className='navbar--dropdown__header'>
                FILTRAR VEGGIEBOX
              </Dropdown.Header>
