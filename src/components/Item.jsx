...
const Item = ({id, title, category, shortDescription, price, img500, img700, cookingTime, cookingDifficulty, nVcalories, servings}) => {
	const customStyle = {
		backgroundColor: '',
	};
	...
	return (
		<Card className='card'>
			...
			<Link to={`/item/${id}`} className='card--button shadow-0' style={customStyle}>
